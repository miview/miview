# Contributing to miview

The following is a set of guidelines for contributing to miview. Please spend several minutes in reading these guidelines before you create an issue or pull request.
...
```bash
git clone git@github.com:ly2011/miview.git
